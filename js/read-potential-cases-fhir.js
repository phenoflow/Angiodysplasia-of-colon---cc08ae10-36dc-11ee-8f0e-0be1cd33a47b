...
(async () => {
  ...
  await fs.writeFile("angiodysplasia-of-colon-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("angiodysplasia-of-colon-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
